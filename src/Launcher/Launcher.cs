...
namespace Remoter
{
	...
	public class Launcher
    {
        ...
        public Launcher( AppDef appDef, String rootForRelativePaths, Dictionary<string, string> internalVars )
        {
            this.appDef = appDef;
       ...
       string BuildAbsolutePath( string anyPath )
        ...
        void LaunchExe( ParsedExe pe )
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"Failed to start app '{appDef.ExeFullPath}'. Reason={ex.Message}" );
            }
		...
		void SetPriorityClass( string priorityClass )
		{
            ...
            log.DebugFormat("{0}: Setting PriorityClass = {1}", appDef.ExeFullPath, prioClassNum.ToString());
